...
![image-20200811170707128](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811170707128.png)

> 2、Memcached（缓存）+ Mysql + 垂直拆分（读写分离）

发展过程：优化数据库结构和索引--》文件缓存--》Memcached（当时最热门）

不缺人、竞争对手是那些图安稳又踏实的人

![image-20200811170848756](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811170848756.png)



> 3、分库分表 + 水平拆分 + Mysql 集群

![image-20200811171333323](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811171333323.png)

> 4、最近的年代，数据量很多，变化很快，大数据的 IO 压力

> 5、目前基本的互联网项目

![image-20200811171712022](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811171712022.png)

### 2、非关系型数据库

很多的数据类型：用户个人信息、社交网络、地理位置。这些数据的存储都不需要一个固定的格式，需要横向扩展！Map<String,Object>
...
2. 大数据量高性能（Redis 一秒8万次，读取11万，Nosql的缓存记录级，细粒度缓存，性能比较高）
...
![image-20200811173705412](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811173705412.png)

![image-20200811173727291](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811173727291.png)
...
![image-20200811202728644](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811202728644.png)

![image-20200811202927753](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811202927753.png)

以上都是  NoSQL 入门概述，不仅能够提高知识，还可以了解大厂的工作内容
...
**文档型数据库**（bjson 和 json一样）

- MongoDB（必须掌握）
  - MongoDB 基于分布式文件存储的数据库，主要用来处理大量的文档
  - MongoDB 是一个介于关系型数据库和非关系型数据库之间的数据库！非关系型数据库中功能最丰富的
  - 
- conthDB
...
![image-20200811204122459](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811204122459.png)
...
Redis 会周期性把更新的数据写入磁盘或者把修改操作写入追加的记录文件、并在此基础上实现了主从同步，免费和开源！
...
![image-20200811231436399](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200811231436399.png)
...
![image-20200812094445400](C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200812094445400.png)

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200812094602373.png" alt="image-20200812094602373" style="zoom:80%;" />

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200812094702452.png" alt="image-20200812094702452" style="zoom:80%;" />

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200812094758835.png" alt="image-20200812094758835" style="zoom: 67%;" />

<img src="C:\Users\Admin\AppData\Roaming\Typora\typora-user-images\image-20200812094928421.png" alt="image-20200812094928421" style="zoom:80%;" />
...
~~~bash
127.0.0.1:6379> LPUSH list one two three #将一个或者多个值，插入到列表头部（左）
(integer) 3
127.0.0.1:6379> LRANGE list 0 -1 #获取 list 里边所有值
1) "three"
2) "two"
3) "one"
...
(integer) 4
127.0.0.1:6379> LRANGE list 0 -1  #将一个或者多个值，插入到列表尾部（左）
1) "three"
2) "two"
3) "one"
4) "four"
...
1) "two"
2) "one"
127.0.0.1:6379> LINDEX list 0  #获取 list 的某一个值
"two"
127.0.0.1:6379>
~~~
